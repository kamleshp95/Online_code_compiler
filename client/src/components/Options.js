...
const languages = ["java", "python", "ruby", "golang", "csharp", "elixir"];
...
class Options extends Component {
  ...
  downloadFile = () => {
    ...
    switch (this.props.file.mode) {
      ...
      case "elixir":
        ...
        break;
      default:
        ext = this.props.file.mode;
        break;
    }
    if (this.props.file.name) fileName = this.props.file.name + "." + ext;
    else fileName = "Code." + ext;
  ...
  render() {
    ...
    return (
      <Form>
        {this.state.msg ? (
          <Alert variant="dark">{this.state.msg + "!!!"}</Alert>
        ) : null}
